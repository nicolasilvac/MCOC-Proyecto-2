...
def particula(z,t):
	...
	for i in range(Nparticulas):
		...
		#altura de suelo se toma como si hubiera una cama de particulas de altura "y"
		x = linspace(0, 20*d,4000)
		x_mod_d = (x % d) - d/2
		y = sqrt((d/2)**2 - x_mod_d**2) #altura del suelo
		if xi[1] < y[i]:	#la particula no puede estar mas abajo que el piso (altura de una cama de particulas)
